...
if __name__ == "__main__":
    ...
    import sys
    import pickle
    folder = '/home/anglahel/data in pickles/training/'
    ...
    if os.path.exists("./errors_train"):
    ...
    for i in range(30):
        ...
        for f in os.listdir(folder):
            ...
            print("\t" + str(sen_true))
            print("\t" + str(sen_calc))
            if not os.path.exists("./errors_train/" + str(i)):
                os.mkdir("./errors_train/" + str(i))
            print("Writing data!")
            with open("./errors_train/" + str(i) + "/abs_diff", 'a') as f:
                np.savetxt(f, np.array(sen_abs))

            with open("./errors_train/" + str(i) + "/true_sal", 'a') as f:
                np.savetxt(f, np.array([sen_true]))

            with open("./errors_train/" + str(i) + "/calc_sal", 'a') as f:
